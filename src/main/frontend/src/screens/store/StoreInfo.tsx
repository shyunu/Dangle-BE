  ...
  return (
    <div className="page-content">
      <div className="page-title-bar">
        ...
        <p>{store.storeName}</p>
        {isSavedStore ? (
          <FaHeart onClick={() => setIsSavedStore(false)} style={{ color: "#E78A99", width: "30px", height: "100%" }} />
        ) : (
          <FaRegHeart
            onClick={() => setIsSavedStore(true)}
            style={{ color: "#E78A99", width: "30px", height: "100%" }}
          />
        )}
      </div>
              ...
              <div className="designer-wrap">
                {designerData && designerData.length > 0 ? (
                  designerData.map((designer) => (
                    <div
                      key={designer.designerNo}
                      className="designer-box"
                      onClick={() => selectDesigner(designer.designerNo)}
                    >
                      ...
                      <p className="designer-info">{designer.designerInfo}</p>
                      <div className="designer-border"></div>
                    </div>
                  ))
                ) : (
